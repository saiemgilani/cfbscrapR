...
vignette: >
  %\VignetteIndexEntry{College-Football-Expected-Points-Model-Fundamentals-Part-I}
  %\VignetteEngine{knitr::rmarkdown}
  %\Vignette{check_title=FALSE}
...
# The Data
We will be acquiring data from [CollegeFootballData.com](collegefootballdata.com), courtesy of @[CFB_data](https://twitter.com/CFB_data), using  `cfbscrapR`, created by [Saiem Gilani](https://twitter.com/saiemgilani), [Meyappan Subbaiah](https://twitter.com/msubbaiah1), and [Parker Fleming](https://twitter.com/statsowar).
...
<a href="https://imgur.com/J7NTeGj"><img src="https://i.imgur.com/J7NTeGj.png" title="Figure: @SaiemGilani" /></a>
...
<a href="https://imgur.com/09yN1Ag"><img src="https://i.imgur.com/09yN1Ag.png" title="Figure: @SaiemGilani" /></a>
