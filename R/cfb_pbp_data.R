...
#' @param play_type Select play type (example: see the [cfbscrapR::cfb_play_type_df()])
...
#'
#' @param play_df (*data.frame* required): Adds play counts to Play-by-Play dataframe, as pulled from `cfb_pbp_data()`
...
#'
#' @param dat (*Data.Frame* required) Clean Play-by-Play DataFrame pulled from `cfb_pbp_dat()`
