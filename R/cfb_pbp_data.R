...
#' @param play_type Select play type (example: see the \code{\link[cfbscrapR:cfb_play_type_df]{cfb_play_type_df}})
...
#'
#' @param play_df (\emph{data.frame} required): Adds play counts to Play-by-Play dataframe, as pulled from `cfb_pbp_data()`
