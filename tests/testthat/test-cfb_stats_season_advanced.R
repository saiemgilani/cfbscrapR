...
x <- cfb_stats_season_advanced(year = 2018, start_week = 8, end_week = 12, team = 'Texas A&M')

y <- cfb_stats_season_advanced(2019, team = 'LSU')

z <- cfb_stats_season_advanced(2013, team = "Florida State")
