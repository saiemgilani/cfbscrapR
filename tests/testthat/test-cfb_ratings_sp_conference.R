...
test_that("CFB Conference Ratings - Bill C.'s SP+", {
  x <- cfb_ratings_sp_conference(year = 2019)
  y <- cfb_ratings_sp_conference(year = 2012, conference = 'SEC')
  z <- cfb_ratings_sp_conference(year = 2016, conference = 'ACC')
  
  cols <- c('year',
            'conference','rating','second_order_wins', 'sos',
